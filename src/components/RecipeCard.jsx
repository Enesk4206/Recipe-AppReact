import { Soup,Heart,HeartPulse, HelpCircle, Tangent } from 'lucide-react'
...
const RecipeCard = ({recipe}) => {
    ...
    const [isFavorite , setIsFavorites] = useState(localStorage.getItem('favorites')?.includes(recipe.label));
